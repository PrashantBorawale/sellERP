const fs = require('fs');
const file = 'c:/Users/admin/Desktop/FinalFiles/5-6_ERP/src/PurchaseMaster/Report/PurchaseOrderList1/PurchseOderList.jsx';
...
const headerRegex = /<div className="PurchseOrderList-header[\s\S]*?<\/div>\s*<\/div>\s*<\/div>/;
const newHeader = `<div className="PurchseOrderList-header text-start mt-5">
                    <div className="row align-items-center mb-4">
                      ...
                      <div className="col-md-9 d-flex justify-content-end" style={{ gap: '0.75rem', flexWrap: 'wrap' }}>
                        <Button 
                          variant="contained" 
...
console.log("Successfully transformed PurchseOderList.jsx!");
