                  ...
                  <div className="card shadow-sm border-0 mb-4" style={{ borderRadius: '12px' }}>
                    <div className="card-body p-0">
                      ...
                      <thead className="table-light">
                        <tr>
                          <th style={{ fontSize: "0.65rem", padding: "4px 2px", textAlign: "center", backgroundColor: "#f8fafc", color: "#475569", whiteSpace: "normal", wordBreak: "normal", overflowWrap: "break-word", width: "3%" }}>Sr.</th>
                          <th style={{ fontSize: "0.65rem", padding: "4px 2px", textAlign: "center", backgroundColor: "#f8fafc", color: "#475569", whiteSpace: "normal", wordBreak: "normal", overflowWrap: "break-word", width: "4%" }}>Year</th>
                          <th style={{ fontSize: "0.65rem", padding: "4px 2px", textAlign: "center", backgroundColor: "#f8fafc", color: "#475569", whiteSpace: "normal", wordBreak: "normal", overflowWrap: "break-word", width: "6%" }}>GRN No.</th>
                          <th style={{ fontSize: "0.65rem", padding: "4px 2px", textAlign: "center", backgroundColor: "#f8fafc", color: "#475569", whiteSpace: "normal", wordBreak: "normal", overflowWrap: "break-word", width: "5.5%" }}>GRN Date</th>
                          <th style={{ fontSize: "0.65rem", padding: "4px 2px", textAlign: "center", backgroundColor: "#f8fafc", color: "#475569", whiteSpace: "normal", wordBreak: "normal", overflowWrap: "break-word", width: "6%" }}>Challan No.</th>
                          <th style={{ fontSize: "0.65rem", padding: "4px 2px", textAlign: "center", backgroundColor: "#f8fafc", color: "#475569", whiteSpace: "normal", wordBreak: "normal", overflowWrap: "break-word", width: "8%" }}>Challan Date</th>
                          <th style={{ fontSize: "0.65rem", padding: "4px 2px", textAlign: "center", backgroundColor: "#f8fafc", color: "#475569", whiteSpace: "normal", wordBreak: "normal", overflowWrap: "break-word", width: "6%" }}>Inv. No.</th>
                          <th style={{ fontSize: "0.65rem", padding: "4px 2px", textAlign: "center", backgroundColor: "#f8fafc", color: "#475569", whiteSpace: "normal", wordBreak: "normal", overflowWrap: "break-word", width: "5.5%" }}>Inv. Date</th>
                          <th style={{ fontSize: "0.65rem", padding: "4px 2px", textAlign: "center", backgroundColor: "#f8fafc", color: "#475569", whiteSpace: "normal", wordBreak: "normal", overflowWrap: "break-word", width: "18.5%" }}>Supplier Name</th>
                          <th style={{ fontSize: "0.65rem", padding: "4px 2px", textAlign: "center", backgroundColor: "#f8fafc", color: "#475569", whiteSpace: "normal", wordBreak: "normal", overflowWrap: "break-word", width: "6%" }}>PO No.</th>
                          <th style={{ fontSize: "0.65rem", padding: "4px 2px", textAlign: "center", backgroundColor: "#f8fafc", color: "#475569", whiteSpace: "normal", wordBreak: "normal", overflowWrap: "break-word", width: "6%" }}>Total</th>
                          <th style={{ fontSize: "0.65rem", padding: "4px 2px", textAlign: "center", backgroundColor: "#f8fafc", color: "#475569", whiteSpace: "normal", wordBreak: "normal", overflowWrap: "break-word", width: "5%" }}>User</th>
                          <th style={{ fontSize: "0.65rem", padding: "4px 2px", textAlign: "center", backgroundColor: "#f8fafc", color: "#475569", whiteSpace: "normal", wordBreak: "normal", overflowWrap: "break-word", width: "3%" }}>View</th>
                          <th style={{ fontSize: "0.65rem", padding: "4px 2px", textAlign: "center", backgroundColor: "#f8fafc", color: "#475569", whiteSpace: "normal", wordBreak: "normal", overflowWrap: "break-word", width: "4.5%" }}>Auth1</th>
                          <th style={{ fontSize: "0.65rem", padding: "4px 2px", textAlign: "center", backgroundColor: "#f8fafc", color: "#475569", whiteSpace: "normal", wordBreak: "normal", overflowWrap: "break-word", width: "4.5%" }}>Auth2</th>
                          <th style={{ fontSize: "0.65rem", padding: "4px 2px", textAlign: "center", backgroundColor: "#f8fafc", color: "#475569", whiteSpace: "normal", wordBreak: "normal", overflowWrap: "break-word", width: "4.5%" }}>QC</th>
                          <th style={{ fontSize: "0.65rem", padding: "4px 2px", textAlign: "center", backgroundColor: "#f8fafc", color: "#475569", whiteSpace: "normal", wordBreak: "normal", overflowWrap: "break-word", width: "4%" }}>Select</th>
                        </tr>
                      </thead>
                      <tbody>
                         {Array.isArray(reportData) && reportData.map((data, index) => (
                          <tr key={data.id}>
                            <td style={{ fontSize: "0.65rem", padding: "4px 2px", textAlign: "center", color: "#475569", whiteSpace: "normal", wordBreak: "normal", overflowWrap: "break-word", width: "3%" }}>{index + 1}</td>
                            <td style={{ fontSize: "0.65rem", padding: "4px 2px", textAlign: "center", color: "#475569", whiteSpace: "normal", wordBreak: "normal", overflowWrap: "break-word", width: "4%" }}>{data.year}</td>
                            <td style={{ fontSize: "0.65rem", padding: "4px 2px", textAlign: "center", color: "#475569", whiteSpace: "normal", wordBreak: "normal", overflowWrap: "break-word", width: "6%" }}>
                              <div style={{ whiteSpace: "pre-wrap", wordBreak: "break-word", minWidth: 0 }}>{data.grnNo}</div>
                            </td>
                            <td style={{ fontSize: "0.65rem", padding: "4px 2px", textAlign: "center", color: "#475569", whiteSpace: "normal", wordBreak: "normal", overflowWrap: "break-word", width: "5.5%" }}>{data.grnDate}</td>
                            <td style={{ fontSize: "0.65rem", padding: "4px 2px", textAlign: "center", color: "#475569", whiteSpace: "normal", wordBreak: "normal", overflowWrap: "break-word", width: "6%" }}>
                              <div style={{ whiteSpace: "pre-wrap", wordBreak: "break-word", minWidth: 0 }}>{data.challanNo}</div>
                            </td>
                            <td style={{ fontSize: "0.65rem", padding: "4px 2px", textAlign: "center", color: "#475569", whiteSpace: "normal", wordBreak: "normal", overflowWrap: "break-word", width: "5.5%" }}>{data.challanDate}</td>
                            <td style={{ fontSize: "0.65rem", padding: "4px 2px", textAlign: "center", color: "#475569", whiteSpace: "normal", wordBreak: "normal", overflowWrap: "break-word", width: "6%" }}>
                              <div style={{ whiteSpace: "pre-wrap", wordBreak: "break-word", minWidth: 0 }}>{data.invoiceNo}</div>
                            </td>
                            <td style={{ fontSize: "0.65rem", padding: "4px 2px", textAlign: "center", color: "#475569", whiteSpace: "normal", wordBreak: "normal", overflowWrap: "break-word", width: "5.5%" }}>{data.invoiceDate}</td>
                            <td style={{ fontSize: "0.65rem", padding: "4px 2px", textAlign: "center", color: "#475569", whiteSpace: "normal", wordBreak: "normal", overflowWrap: "break-word", width: "21%" }}>
                            ...
                            <td style={{ fontSize: "0.65rem", padding: "4px 2px", textAlign: "center", color: "#475569", whiteSpace: "normal", wordBreak: "normal", overflowWrap: "break-word", width: "6%" }}>{data.total}</td>
                            <td style={{ fontSize: "0.65rem", padding: "4px 2px", textAlign: "center", color: "#475569", whiteSpace: "normal", wordBreak: "normal", overflowWrap: "break-word", width: "5%" }}>{data.user}</td>
                            <td style={{ fontSize: "0.65rem", padding: "4px 2px", textAlign: "center", color: "#475569", whiteSpace: "normal", wordBreak: "normal", overflowWrap: "break-word", width: "3%" }}>
                              <FaEye 
                            ...
                            <td style={{ fontSize: "0.65rem", padding: "4px 2px", textAlign: "center", color: "#475569", whiteSpace: "normal", wordBreak: "normal", overflowWrap: "break-word", width: "4.5%" }}><div className="badge bg-success p-1"><FaCheck /></div></td>
                            <td style={{ fontSize: "0.65rem", padding: "4px 2px", textAlign: "center", color: "#475569", whiteSpace: "normal", wordBreak: "normal", overflowWrap: "break-word", width: "4.5%" }}><div className="badge bg-success p-1"><FaCheck /></div></td>
                            <td style={{ fontSize: "0.65rem", padding: "4px 2px", textAlign: "center", color: "#475569", whiteSpace: "normal", wordBreak: "normal", overflowWrap: "break-word", width: "4.5%" }}>
                                {index % 3 === 0 ? 
